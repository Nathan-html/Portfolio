    ...
    >
      ...
      >
        ...
        <Box display={'flex'} alignItems={'center'}>
          ...
          <Button variant={'ghost'}>
            <Link href="/achievements">réalisations</Link>
          </Button>
              ...
              <Menu>
                <MenuButton>
                  <Avatar
                    ...
                    src={
                      session.user?.image ||
                      'https://lh3.googleusercontent.com/a/AEdFTp6cfcwnk0M4own9sdGKeRUDILLnUSb_AuLGfXgR=s96-c'
                    }
                    size={{ base: 'sm' }}
                  />
                </MenuButton>
