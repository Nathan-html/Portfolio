            ...
            data: [
                {
                    ...
                    tag: "Design",
                    desc: "",
                    imageSrc: "https://cdn.pixabay.com/photo/2022/11/23/16/03/butterfly-7612383_960_720.jpg",
                    imageAlt: "placeholder"
                }, {
                    title: "Diagram Creator",
                    tag: "Développement web",
                    desc: "",
                    imageSrc: "https://cdn.pixabay.com/photo/2022/11/29/16/34/bird-7624853_960_720.jpg",
                    imageAlt: "placeholder"
                }, {
                    title: "PiCom",
                    tag: "Développement mobile",
                    desc: "",
                    imageSrc: "https://cdn.pixabay.com/photo/2012/06/19/10/32/owl-50267_960_720.jpg",
                    imageAlt: "placeholder"
                }
            ]
        });
        console.log(`${achievementsCreated.count.toString()} achievements was been created`);
    } else {
        console.log(`${achievementsCount.toString()} achievements was already in the database`);
    }
})
    ...
    if (skillsCount === 0) {
        const skillsCreated = await prisma.skill.createMany({
            data: [
                {
                    name: 'Git',
                    title: "Versionner une application grace a l'outils de control de versions Git",
                    desc: "en association avec d'autre outils tel que github ou gitlab qui propose des services d'hébergement, " +
...
prisma.historyitem.count().then(async (historyItemCount: number) => {
    if (historyItemCount === 0) {
        ...
        console.log(`${historyItemCount.toString()} history item was already in the database`);
    }
})
